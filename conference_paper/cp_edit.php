...
<div class="page-content">
    ...
    <form action="/~D1285210/conference_paper/update.php" method="post">
        ...
        <label><h3>論文名稱</h3><br><input type="text" name="title" value="<?= htmlspecialchars($data['title']) ?>" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        ...
        <label><h3>會議名稱</h3><br><input type="text" name="conference_name" value="<?= htmlspecialchars($data['conference_name']) ?>" placeholder="請輸入會議名稱" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        <label><h3>與會地點</h3><br><input type="text" name="locations" value="<?= htmlspecialchars($data['locations']) ?>" placeholder="請輸入與會地點" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        <label><h3>會議日期</h3><br><input type="date" name="conference_date" value="<?= $data['conference_date'] ?>" placeholder="請輸入會議日期" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
