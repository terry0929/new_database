...
<div class="page-content">
    ...
    <form action="/~D1285210/nstc_projects/save.php" method="post">
        ...
        <label><h3>專案編號</h3><br><input type="text" name="project_number" placeholder="請輸入專案編號" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        <label><h3>資助單位</h3><br><input type="text" name="funding_agency" placeholder="請輸入資助單位" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        <label><h3>資助金額</h3><br><input type="number" name="amount" placeholder="請輸入資助金額" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        <label><h3>計劃開始日期</h3><br><input type="date" name="starts_date" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        <label><h3>計劃結束日期</h3><br><input type="date" name="end_date" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        <label><h3>上傳日期</h3><br><input type="date" name="upload_date" style="width:80%; padding:10px; font-size: 16px;" required></label><br><br>
        <label><h3>計劃摘要</h3><br><textarea name="summary" placeholder="請輸入計劃摘要" style="width:80%; padding:10px; font-size: 16px;" required></textarea></label><br><br>
